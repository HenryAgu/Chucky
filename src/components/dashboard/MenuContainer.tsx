...
const MenuContainer = () => {
  ...
  // ];
  return (
    <section className="shadow-md flex flex-col rounded-md mt-5 w-full p-5 mb-14">
      <div className="flex flex-col gap-y-2 border-b">
        ...
        <div className="flex items-center justify-end px-2 xl:px-5">
          <ul className="flex items-center gap-x-5 font-[inter] overflow-x-auto">
      ...
      <div className="flex overflow-x-auto xl:overflow-x-hidden w-full gap-x-5 gap-y-5 mt-5">
