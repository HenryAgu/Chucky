...
const notoSans = Noto_Sans({subsets:["latin"],  weight:["400", "700", "900"], variable: '--font-notoSans'})
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${creteRound.className} ${inter.className} ${notoSans.className} antialiased`}>{children}</body>
    </html>
  );
}
